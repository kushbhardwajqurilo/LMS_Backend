...
exports.forgotPassword = async (req, res) => {
  try {
    ...
    // Reset in case of a new request
    ...
    const emailTemplate = await ejs.renderFile(
      path.join(__dirname, "../emailTemplates/verifyEmail.ejs"),
      {
        ...
        message:
          "Please click the button below to reset your password. If you did not request a password reset, please ignore this email.",
      },
    );
    ...
    console.log("foregt error", error);
...
exports.resetPassword = async (req, res) => {
  try {
    ...
    console.log("hello", { newPassword, confirmPassword });
    // Verify token
...
exports.changePassword = async (req, res) => {
  try {
    ...
    console.log("Received:", { oldPassword, newPassword, confirmPassword });
